...
* C++の勉強用ファイルとも相まって若干プログラミング学習用にリポジトリを分けたくなっている。
...
int i=0;
```
で初期化しないとゴミデータが入るのはわかるけどさ...これに慣れるのにいくら時間がかかかることか。

## 2026/09/01

ついに9月、JOI界隈が騒がしくなってきたなぁ...

AQUOSのスマホを通学路にあるハードオフで購入。ハンディファン(550円)より安い330円。Android 4でした。300円でハードウェアが手に入るのだからあそこは魔境だ。

リラックスとリナックスって似てますね。

## 2026/09/01
ABC477 今までよりは解けた。少しずつレーティングを地味に上げている。

自転車移動していたら道路の縁石につまずいてこけました。あの縁石許さん。
